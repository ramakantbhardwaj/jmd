...
public class AdapterFabricator extends RecyclerView.Adapter<AdapterFabricator.FabricViewHolder> {
//    FabicatorModel fabicatorModel;
    ...
    public AdapterFabricator( List<LstEmbDetail> itemList, Context context, boolean isSelectionEnabled) {
        this.itemList = itemList;
        this.context = context;
        this.isSelectionEnabled=isSelectionEnabled;
    }
    @Override
    public AdapterFabricator.FabricViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_fabricator,parent,false);
        return new AdapterFabricator.FabricViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterFabricator.FabricViewHolder holder, @SuppressLint("RecyclerView") int position) {
        if (position%2==0){
